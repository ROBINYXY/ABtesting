...
review.df <- ________(file("________"))
...
meta.df <- ________(file("________"))
...
write.csv(meta.df, file ="AllBeautyMeta.csv")
...
data <- ________ # drop observations without brand information
